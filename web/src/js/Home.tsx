...
export function Home(props: any) {
    ...
    return <div id='page' className='home'>
        ...
        <p className='home-description'>
            Travelers beware: The Journey to Mount Sogol is a peculiar one, because the destination is not a physical place. That is not to say it's not <i>real</i>. What it means, though, is that Mount Sogol is to be found on a different plane of existence, not in the mundane world. But can it be reached? Well...<br/><br/><i>the door to the invisible must be visible</i>.
        </p>
